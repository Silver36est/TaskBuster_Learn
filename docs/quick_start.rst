...
This project is named *TaskBuster*, so if you are using this Boilerplate
to create your own project, you'll have to change the mane in few places:

- *taskbuster_project* **folder** (your top project container)
- *taskbuster_project/taskbuster* **folder** (your project name)
- virtualenvironment names: **tb_dev** and **tb_test** (name them whatever you want)
...
Next, edit te **predeactivate** file and add the line::
...
The default language for this Project is **English**, and we use internationalization to translate the text into Estonian.
...
You can also specify a dialect, like Luxenbourg's German with::

	LANGUAGES = (
		...
		'de-lu', _("Luxenbourg's German"),
		...
	)
...
.. |internationalization_post| raw:: html
	...
	<a href="http://marinamele.com/taskbuster-django-tutorial/internationalization-languages-time-zones" target="_blank">Taskbuster post</a>
...
change the language "et" for your selected language.

Next, go to the locale foldeer of your language::

	$ cd taskbuster/locale/et/LC_MESSAGES
...
- in **test_internationalization**, update you language with the translation of title text, here "Welcome to TaskBuster!"
...
Alist of all the commands used to run this template::
